            ...
            <div class="table-filter-div" id="item-filter">
                <form class="p-4 sm:p-5 mb-5" @submit.prevent="search">
                    <div class="row">
                        ...
                        <div class="col-12 sm:col-6 md:col-4 xl:col-3">
                            <label for="searchIsVariable" class="db-field-title after:hidden">{{
                                $t("label.is_variable")
                            }}</label>
                            <vue-select class="db-field-control f-b-custom-select" id="searchIsVariable"
                                v-model="props.search.is_variable" :options="[
                                    { id: enums.askEnum.YES, name: $t('label.yes') },
                                    { id: enums.askEnum.NO, name: $t('label.no') },
                                ]" label-by="name" value-by="id" :closeOnSelect="true" :searchable="true"
                                :clearOnClose="true" placeholder="--" search-placeholder="--" />
                ...
                <table class="db-table stripe" id="print" :dir="direction">
                    ...
                    <tbody class="db-table-body" v-if="items.length > 0">
                        <tr class="db-table-body-tr" v-for="item in items" :key="item">
                            ...
                            <td class="db-table-body-td">
                                <span :class="item.is_variable === enums.askEnum.YES ? 'badge-success' : 'badge-warning'">
                                    {{ enums.askEnumArray[item.is_variable] }}
                                </span>
                            </td>
                            <td class="db-table-body-td">
...
export default {
    ...
    methods: {
        ...
        clear: function () {
            ...
            this.props.search.is_variable = null;
            this.list();
        },
