        ...
        <div class="drawer-body">
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title" for="variable">{{ $t("label.is_variable") }}</label>
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input type="radio" v-model="props.form.is_variable" id="variable"
                                        :value="enums.askEnum.YES" class="custom-radio-field" @change="handleVariableChange">
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="variable" class="db-field-label">{{ $t('label.yes') }}</label>
                            </div>
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input type="radio" class="custom-radio-field" v-model="props.form.is_variable"
                                        id="notVariable" :value="enums.askEnum.NO" @change="handleVariableChange">
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="notVariable" class="db-field-label">{{ $t('label.no') }}</label>
                            </div>
                        </div>
                    </div>

                    <div class="form-col-12 sm:form-col-6" v-if="!props.form.is_variable || props.form.is_variable === enums.askEnum.NO">
    ...
    methods: {
        ...
        save: function () {
            try {
                ...
                fd.append('is_variable', this.props.form.is_variable);
        ...
        handleVariableChange: function () {
            if (this.props.form.is_variable === this.enums.askEnum.YES) {
                // If product is variable, set price to 0
                this.props.form.price = "0";
            }
        }
    }
}
